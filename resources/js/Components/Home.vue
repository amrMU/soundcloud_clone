<template>
    <div>
        <div class="welcome-box">
            ...
            <img src="https://a-v2.sndcdn.com/assets/images/sc_landing_header_web_a-3bb2d420.jpg" class="bg-home">
            <h3 class="title-welcome text-center">Connect on SoundCloud</h3>
            <p class="text-center content-welcome">
